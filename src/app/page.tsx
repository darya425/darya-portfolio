      ...
      <section className="h-full">
        <div className="container mx-auto h-full">
          <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
            ...
            <div
              className="flex items-center order-1 xl:order-none w-[298px] h-[298px] xl:w-[498px] xl:h-[498px] sm:mb-2">
              {/*<Photo />*/}
              <Image src="/assets/my-photo.jpg" alt="" width={498} height={498} className='rounded-full' />
            </div>
          </div>
        </div>
        <Stats />
